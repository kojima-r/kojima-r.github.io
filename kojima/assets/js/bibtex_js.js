...
// rewrited by O. Sugiyama 2013/08/07
function bibtex_js_draw() {
  $(".bibtex_template").hide();
  if ('bibtex_input' in window) {
    //console.log("find bibtex_input");
    //console.log("bibtex_input:" + bibtex_input);
    (new BibtexDisplay()).displayBibtex($("#bibtex_input").val(), $("#bibtex_display"));
  } else {
    //console.log("load bibtex_input text area directly");
    //console.log ($("#bibtex_input").val());
    (new BibtexDisplay()).displayBibtex(bibtex_input, $("#bibtex_display"));
  }
}
